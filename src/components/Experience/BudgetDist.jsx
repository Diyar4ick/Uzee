          ...
          <div className="container">
            ...
            <div className="corp-manage-page__content">
              <h3 className="main-title">
                Предлагаемое распределение чистой прибыли
              </h3>
              <table className="corp-manage-page__table">
                <tbody>
                  <tr>
                    <td colSpan={2} className="corp-manage-page__table-title"><p>Предлагаемое распределение чистой прибыли</p></td>
                  </tr>
                  <tr>
                    <td><p>Предлагаемое распределение чистой прибыли на 2024 год</p></td>
                    <td><a href="">Посмотреть</a></td>
                  </tr>
                  <tr>
                    <td><p>Предлагаемое распределение чистой прибыли на 2022 год</p></td>
                    <td><a href="">Посмотреть</a></td>
                  </tr>
                </tbody>
              </table>
