    ...
    <div className="corp-manage-page">
      <div className="container">
        ...
        <div className="corp-manage-page__content">
          <h3 className="main-title">АУДИТОРСКИЕ ЗАКЛЮЧЕНИЯ МСФО</h3>
          <table className="corp-manage-page__table">
            <tbody>
              <tr>
                <td>
                  <p>Аудиторское заключение 2024 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
              ...
              <tr>
                <td>
                  <p>Аудиторское заключение 2023 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
              ...
              <tr>
                <td>
                  <p>Аудиторское заключение 2022 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
              ...
              <tr>
                <td>
                  <p>Аудиторское заключение 2021 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
              ...
              <tr>
                <td>
                  <p>Аудиторское заключение 2020 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
              ...
              <tr>
                <td>
                  <p>Аудиторское заключение 2019 год</p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
                </td>
          ...
          <h3 className="main-title">АУДИТОРСКИЕ ЗАКЛЮЧЕНИЯ НСБУ</h3>
          <table className="corp-manage-page__table">
            <tbody>
              <tr>
                <td>
