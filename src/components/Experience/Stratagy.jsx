          ...
          <table className="corp-manage-page__table">
            <tbody>
              <tr>
                <td>
                  <p>
                    Среднесрочный бизнес план развития общества на 2021-2026 годы
                  </p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
              ...
              <tr>
                <td>
                  <p>
                    Среднесрочный бизнес план развития общества на 2017-2021 годы
                  </p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
              ...
              <tr>
                <td>
                  <p>
                    Бизнес план общества на 2014 год
                  </p>
                </td>
                <td>
                  <a href="">Посмотреть</a>
