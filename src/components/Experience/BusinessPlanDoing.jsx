      ...
      <div className="container">
        ...
        <div className="corp-manage-page__content">
          ...
          <table className="corp-manage-page__table">
            <tbody>
              <tr>
                <td colSpan={2} className="corp-manage-page__table-title"><p>Выполнение бизнес плана</p></td>
              </tr>
              <tr>
                <td><p>Предлагаемое распределение чистой прибыли на 2021 год</p></td>
                <td><a href="">Посмотреть</a></td>
              </tr>
              <tr>
                <td><p>СРАВНИТЕЛЬНАЯ ТАБЛИЦА ПО ОСНОВНЫМ ТЕХНИКО-ЭКОНОМИЧЕСКИМ ПОКАЗАТЕЛЯМ ЗА 2018-2021гг. (МСФО)</p></td>
                <td><a href="">Посмотреть</a></td>
              </tr>
              <tr>
                <td><p>СРАВНИТЕЛЬНАЯ ТАБЛИЦА ПО ОСНОВНЫМ ТЕХНИКО-ЭКОНОМИЧЕСКИМ ПОКАЗАТЕЛЯМ ЗА 2018-2021гг. (НСБУ)</p></td>
                <td><a href="">Посмотреть</a></td>
              </tr>
            </tbody>
          </table>
...
export default BusinessPlanDoing