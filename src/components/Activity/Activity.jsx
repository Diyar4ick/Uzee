  ...
  return (
    <div className="activity-page">
      ...
      <section className="activity-page__section4">
        <div className="container">
          <h4 className="bold">
            Общество осуществляет следующие виды деятельности относящиеся к
            текущей хозяйственной деятельности:
          </h4>
          <ul>
            <li>
              <p>
                проектирование линий электропередачи и подстанций напряжением
                0,4-500kV;
              </p>
            </li>
            <li>
              <p>
                проектирование релейной защиты, системной автоматики,
                телемеханики, средств связи и других устройств, обеспечивающих
                нормальное функционирование электрических сетей;
              </p>
            </li>
            <li>
              <p>
                проектирование газотурбинных, дизельных, малых гидравлических и
                иных электростанций;
              </p>
            </li>
            <li>
              <p>проектирование объектов возобновляемых источников энергии;</p>
            </li>
            <li>
              <p>
                проектирование строительных и ремонтно-эксплуатационных
                объектов, жилых домов и объектов социальной сферы;
              </p>
            </li>
            <li>
              <p>разработка нормативно-методической и типовой документации;</p>
            </li>
            <li>
              <p>
                информационные, консультационные, инженеринговые и другие услуги
                по профилю деятельности Общества;
              </p>
            </li>
            <li>
              <p>
                проведение инженерно-геодезических изысканий и
                инженерно-геологических изысканий (в том числе бурение);
              </p>
            </li>
            <li>
              <p>
                выполнение консалтинговых и экспертных работ в области
                энергетики и смежных с нею отраслях промышленного производства
                по заказам юридических и физических лиц, в том числе –
                иностранных;
              </p>
            </li>
            <li>
              <p>
                разработка всех стадий проектной документации (ТЭР, ТЭО, РД, РП,
                рабочие чертежи);
              </p>
            </li>
            <li>
              <p>подготовка тендерной документации;</p>
            </li>
            <li>
              <p>проведение авторского надзора;</p>
            </li>
            <li>
              <p>
                разработка и внедрение нормативной базы проектирования в области
                энергетического строительства;
              </p>
            </li>
            <li>
              <p>
                адаптация проектной документации на территории Республики
                Узбекистан;
              </p>
            </li>
            <li>
              <p>
                инженеринг, сбор, хранение, изучение, защита, использование и
                реализация научной, коммерческой, технической и экологической
                информации, покупка и продажа технологий, патентов, авторских
                прав и лицензий на использование изобретений;
              </p>
            </li>
            <li>
              <p>
                маркетинг, коммерческая и посредническая деятельность, оказание
                платных услуг предприятиям, организациям и физическим лицам;
              </p>
            </li>
            <li>
              <p>укрепление, развитие материально-технической базы Общества;</p>
            </li>
            <li>
              <p>
                осуществление производственной и хозяйственной деятельности, не
                противоречащей действующему законодательству и соответствующим
                целям деятельности Общества;
              </p>
            </li>
            <li>
              <p>
                в установленном порядке осуществлять внешнеэкономическую
                деятельность;
              </p>
            </li>
            <li>
              <p>
                осуществление арендной деятельности, сдача в аренду движимого и
                недвижимого имущества;
              </p>
            </li>
            <li>
              <p>
                правомочно заниматься другими видами деятельности, не
                запрещённых действующим законодательством Республики Узбекистан
                в целях получения дополнительной прибыли для предприятия.
              </p>
            </li>
          </ul>
        </div>
